...
//This class helps simulate realistic delays and data loading when accessing data from an API
//BaseTest file copied from Google's Android Basics in Kotlin Unit 4 Amphibians project.
